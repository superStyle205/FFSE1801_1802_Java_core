...
public class QuanLySinhVien {
	...
	public void menu() {
		int chooseMenu;
		while (true) {
			System.out.println("1. Nhập SV");
			System.out.println("2. Xuất thông tin SV");
			System.out.println("3. Xuất mấy đứa giỏi");
			System.out.println("4. Sắp xếp danh sách SV theo điểm");
